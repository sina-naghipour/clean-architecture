...
LOG_FILE = os.getenv('LOG_FILE', 'profile_service.log')
...
app = FastAPI(
    title="Ecommerce API - Profile Service",
    description="User profile and address management microservice for Ecommerce API",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
